            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <a href="mailto:thegentlesole22@gmail.com" className="text-primary hover:underline">
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 mb-1">Service Locations</h4>
            ...
            <div className="mt-12">
              ...
              <div className="flex space-x-4">
                <a 
                  ...
                  className="bg-pink-100 text-pink-600 p-3 rounded-lg hover:bg-pink-200 transition-colors"
                >
