      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            ...
            <p className="text-gray-300 mb-4 max-w-md">
              Professional footcare nursing services providing compassionate, 
              expert care directly to your home. Your feet deserve gentle, professional attention.
            </p>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400">
            &copy; 2025 The Gentle Sole. All rights reserved. | 
            <span className="text-sm"> Professional Footcare Nursing Services</span>
          </p>
        </div>
      </div>
    </footer>
